...
class ProtocolBindTest extends \PHPUnit_Framework_TestCase {
    ...
    protected $mappingConfig1 = <<<EOL
        <bind name='test' source="summary" target="activities" parser="ProtoMapper\Parsers\NewlineDelimitedParser" type="Activity">
            <data>
...
EOL;
    ...
    public function testParse() {
        ...
        $this->assertEquals('Activity', $this->object1->type());
        ...
        $this->assertEquals('Duration', $this->object2->type());
